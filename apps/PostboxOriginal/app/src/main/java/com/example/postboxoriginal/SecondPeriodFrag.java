...
public class SecondPeriodFrag extends Fragment {
    RecyclerView rv;
    ...
    public SecondPeriodFrag() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.secondperiodfrag,container,false);
        rv=v.findViewById(R.id.rvsecondfrag);
        fab=v.findViewById(R.id.secondfloatingbutton);
        noperiod=v.findViewById(R.id.noperiod2);
        ...
        dbr=fd.getReference().child("timetables/"+ FirebaseAuth.getInstance().getCurrentUser().getUid()+"/"+date+"/2/");
