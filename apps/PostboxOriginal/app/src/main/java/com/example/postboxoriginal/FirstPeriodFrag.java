...
public class FirstPeriodFrag extends Fragment {
    RecyclerView rv;
    ...
    public FirstPeriodFrag() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View v= inflater.inflate(R.layout.firstperiodfrag,container,false);
       rv=v.findViewById(R.id.rvfirstfrag);
       fab=v.findViewById(R.id.firstfloatingbutton);
       noperiod=v.findViewById(R.id.noperiod1);
       ...
       dbr=fd.getReference().child("timetables/"+ FirebaseAuth.getInstance().getCurrentUser().getUid()+"/"+date+"/1/");
