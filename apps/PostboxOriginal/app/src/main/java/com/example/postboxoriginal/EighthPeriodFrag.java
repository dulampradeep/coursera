...
public class EighthPeriodFrag extends Fragment {
    RecyclerView rv;
    ...
    public EighthPeriodFrag(){

    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.eighthperiodfrag,container,false);
        rv=v.findViewById(R.id.rveighthfrag);
        fab=v.findViewById(R.id.eighthfloatingbutton);
        noperiod=v.findViewById(R.id.noperiod8);
        ...
        dbr=fd.getReference().child("timetables/"+ FirebaseAuth.getInstance().getCurrentUser().getUid()+"/"+date+"/8/");
