...
public class SixthPeriodFrag extends Fragment {
    RecyclerView rv;
    ...
    ImageView noperiod;
    public SixthPeriodFrag(){

    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View v=inflater.inflate(R.layout.sixthperiodfrag,container,false);
        rv=v.findViewById(R.id.rvsixthfrag);
        fab=v.findViewById(R.id.sixthfloatingbutton);
        noperiod=v.findViewById(R.id.noperiod6);
        ...
        dbr=fd.getReference().child("timetables/"+ FirebaseAuth.getInstance().getCurrentUser().getUid()+"/"+date+"/6/");
