...
public class ThirdPeriodFrag extends Fragment {
    RecyclerView rv;
    ...
    public ThirdPeriodFrag() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.thirdperiodfrag,container,false);
        rv=v.findViewById(R.id.rvthirdfrag);
        fab=v.findViewById(R.id.thirdfloatingbutton);
        noperiod=v.findViewById(R.id.noperiod3);
        ...
        dbr=fd.getReference().child("timetables/"+ FirebaseAuth.getInstance().getCurrentUser().getUid()+"/"+date+"/3/");
