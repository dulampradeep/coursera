...
public class FifthPeriodFrag extends Fragment {
    RecyclerView rv;
    ...
    public FifthPeriodFrag(){

    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.fifthperiodfrag,container,false);
        rv=v.findViewById(R.id.rvfifthfrag);
        fab=v.findViewById(R.id.fifthfloatingbutton);
        noperiod=v.findViewById(R.id.noperiod5);
        ...
        dbr=fd.getReference().child("timetables/"+ FirebaseAuth.getInstance().getCurrentUser().getUid()+"/"+date+"/5/");
