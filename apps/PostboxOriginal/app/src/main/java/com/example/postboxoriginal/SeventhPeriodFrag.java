...
public class SeventhPeriodFrag extends Fragment {
    RecyclerView rv;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.seventhperiodfrag,container,false);
        rv=v.findViewById(R.id.rvseventhfrag);
        fab=v.findViewById(R.id.seventhfloatingbutton);
        noperiod=v.findViewById(R.id.noperiod7);
        ...
        dbr=fd.getReference().child("timetables/"+ FirebaseAuth.getInstance().getCurrentUser().getUid()+"/"+date+"/7/");
